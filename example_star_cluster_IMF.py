...
alpha_2 = 2.3
alpha_1 = 1.3
alpha3_model = 2  # 2 or 'R14'
alpha2_model = 'Z'  # 1 or 'R14'
alpha1_model = 'Z'  # 0 or 1
# alpha2_model = 0
# alpha1_model = 0
# alpha_2 = 2.3 + 0.5
# alpha_1 = 1.3 + 0.5
...
# Mass_point_2_to_point_5 = 0
# Mass_point_2_to_1 = 0
# length_of_stellar_mass_list = len(list_stellar_masses)
# i = 0
# while i < length_of_stellar_mass_list:
#     if list_stellar_masses[i]>0.2:
#         if list_stellar_masses[i]<0.5:
#             new_masses = list_stellar_masses[i] * list_stellar_numbers[i]
#             Mass_point_2_to_point_5 += new_masses
#             Mass_point_2_to_1 += new_masses
#         elif list_stellar_masses[i]<1:
#             Mass_point_2_to_1 += list_stellar_masses[i] * list_stellar_numbers[i]
#     (i) = (i+1)
#
# mass_ratio = Mass_point_2_to_point_5/Mass_point_2_to_1
