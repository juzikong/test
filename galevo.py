...
def plot_output(plot_show, plot_save, imf, igimf, SFR, SFEN, log_Z_0, STF):  # SFR is the maximum SFR.
    ...
    if plot_show is True or plot_save is True:
        ...
        fig.add_subplot(1, 1, 1)
        plt.loglog(time_axis, SNIa_number_per_century, label='SNIa', color="tab:red",
...
if __name__ == '__main__':
    ...
    galaxy_evol(imf='igimf', STF=0.5, SFEN=SFEN, Z_0=0.02*1e-16, solar_mass_component="Asplund2009_mass",
                ...
                high_time_resolution=None, plot_show=True, plot_save=None, outflow=100, check_igimf=True)
